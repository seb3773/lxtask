...
void show_about_dialog(void)
{
    ...
    gtk_about_dialog_set_name ( (GtkAboutDialog*)about_dlg, _( "LXTask-mod" ) );
#else
	gtk_about_dialog_set_program_name ( (GtkAboutDialog*)about_dlg, _( "LXTask-mod" ) );
#endif
